...
const CardSwap = ({
  ...
  return (
    <div
      ref={container}
      className="absolute bottom-0 right-0 md:transform md:translate-x-[5%] md:translate-y-[20%] origin-bottom-right perspective-[900px] overflow-visible max-[768px]:left-1/2 max-[768px]:top-1/2 max-[768px]:-translate-x-1/2 max-[768px]:-translate-y-1/2 max-[768px]:scale-[0.85] max-[768px]:bottom-auto max-[768px]:right-auto"
      style={{ width, height }}>
      {rendered}
    </div>
  );
